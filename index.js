...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] XBOT Ready scan now/sekarang anjing jangan lupa ngentod yak!`);
});
...
let hasil = fs.readFileSync('mp3/' + 'aduh' + '.mp3')
 conn.sendMessage(id, hasil, MessageType.audio, { quoted: m } )
}
else if (text == 'dominik'){
let hasil = fs.readFileSync('mp3/' + 'dominik' + '.mp3')
 conn.sendMessage(id, hasil, MessageType.audio, { quoted: m } )
}
else if (text == 'pale'){
let hasil = fs.readFileSync('mp3/' + 'pale' + '.mp3')
 conn.sendMessage(id, hasil, MessageType.audio, { quoted: m } )
}
else if (text == 'tapi'){
let hasil = fs.readFileSync('mp3/' + 'tapi' + '.mp3')
 conn.sendMessage(id, hasil, MessageType.audio, { quoted: m } )
}
else if (text == 'yamete'){
let hasil = fs.readFileSync('mp3/' + 'Yamete' + '.mp3')
 conn.sendMessage(id, hasil, MessageType.audio, { quoted: m } )
}
else if (text == 'Yamete'){
let hasil = fs.readFileSync('mp3/' + 'Yamete' + '.mp3')
...
let hasil = fs.readFileSync('mp3/' + 'bot' + '.mp3')
 conn.sendMessage(id, hasil, MessageType.audio, { quoted: m } )
}
else if (text == 'bot'){
let hasil = fs.readFileSync('mp3/' + 'bot' + '.mp3')
